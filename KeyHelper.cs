...
namespace Helper
{
    ...
    public class CustomKeyEventArgs : KeyEventArgs
    {
        ...
        public CustomKeyEventArgs(Keys key, string language) : base(key)
        {
            Language = language;
        }
    }
    ...
    public class KeyHelper
    {
        ...
        private IntPtr CaptureKey(int nCode, int wp, IntPtr lp)
        {
            if (nCode >= 0)
            {
                ...
                //KeyEventArgs eventArgs = new KeyEventArgs(keyInfo.key); Original
                ////////////////////////////////////////////////+
                CustomKeyEventArgs eventArgs = new CustomKeyEventArgs(keyInfo.key, GetInputLanguage());
